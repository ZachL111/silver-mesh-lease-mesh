"""Regression checks for the silver-mesh-lease-mesh casebook."""
...
from casebook.harness import assert_expected, silver_mesh_lease_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_mesh_lease_mesh_summary(), assert_expected())
